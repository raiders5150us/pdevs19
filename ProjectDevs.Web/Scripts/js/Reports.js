...
$(function () {
    ...
    var reportService = new ReportService(apiService);
    ...
    $(document).on('change', '#filter-team-id', function (e) {
        ...
        if ($('#filter-team-id').select2('data')) {
            ...
            setTimeout(function () {
                if (teamId) {
                    ddlService.setSprintsDdl(false, false, function () {
    ...
    $(document).on('change', '#filter-report-type-id', function (e) {
        ...
        var selectedText = $('#filter-report-type-id option:selected').text() || "";
